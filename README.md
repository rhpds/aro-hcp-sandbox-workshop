# aro-hcp-sandbox-workshop

A hands-on lab in which attendees learn about ARO HCP's managed control plane model and prove OpenShift Sandboxed Containers' kernel-level pod isolation through live host-escape simulations.
...
1. Open in DevSpaces: `https://devspaces.apps.ocpv-infra02.wdc07.infra.demo.redhat.com#https://github.com/rhpds/aro-hcp-sandbox-workshop`
...
2. Clone the repo:
   ```
   git clone https://github.com/rhpds/aro-hcp-sandbox-workshop
   ```
3. `cd aro-hcp-sandbox-workshop`
